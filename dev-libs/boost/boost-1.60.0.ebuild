...
inherit eutils flag-o-matic multilib multiprocessing python-r1 toolchain-funcs versionator multilib-minimal python-utils-r1
...
IUSE="+clang context debug doc icu +nls mpi python static-libs +threads tools"
...
create_user-config.jam() {
	...
	if python_bindings_needed; then
		...
		python_configuration="using python : : ${PYTHON} : ${PYTHON_INCLUDEDIR} ;"
	fi
